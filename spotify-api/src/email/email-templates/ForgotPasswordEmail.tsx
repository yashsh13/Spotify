...
export default function ForgotPasswordEmail({username ,token}: ForgotPasswordEmailProps) {
    return(
        <Html>
            <Head>
                <Font
                ...
                <Body>
                    ...
                    <Section>
                        ...
                        <Text className="text-center">
                            Your reset password link is <Link href={`${parsedEnv.FRONTEND_URL}/reset/${token}`}>here</Link>
                        </Text>
                    </Section>
